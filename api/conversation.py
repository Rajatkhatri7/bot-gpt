...
# async def stream_message(conversation_id: str,payload: dict,db: AsyncSession = Depends(get_db),):
...
#                 # Extract finish reason and usage (last chunk)
